    ...
    >
      ...
      >
        <View className="items-center mb-8">
          ...
          <Text className="text-white font-bold text-3xl mt-3">CeylonTrails</Text>
          <Text className="text-white/80 mt-1">Sign in to continue</Text>
        </View>

        <View className="bg-white/10 border border-white/20 rounded-3xl p-5">
          <Text className="text-white/90 text-xs mb-2">Email</Text>
          <TextInput
            autoCapitalize="none"
          ...
          <View className="flex-row justify-center mt-4">
            <Text className="text-white/80">No account? </Text>
